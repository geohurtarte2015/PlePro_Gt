 ...
 * @author LENOVO
 */
public class GetListSuscriptionsAddons extends HttpServlet {
    
      private Configuration configuration = null;
    
      public GetListSuscriptionsAddons()  {       
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String keyword ="";
        //String country="502";
        phone = String.valueOf(request.getParameter("phone")).trim();
        idAmco = String.valueOf(request.getParameter("amcoId")).trim();
        ...
        parameters.setPHONE(country+phone);
        parameters.setCUSTOMERID("");
        parameters.setPAYMENTTYPE("GUIWEB");
        parameters.setPRODUCTID(idAmco);
        RepuestaInvokeParams responseParams = serviceSuscriptions.serviceActive(parameters);
        
        String message = "Error al agregar la suscrición";
